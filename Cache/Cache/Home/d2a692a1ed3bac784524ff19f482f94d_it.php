                        ...
                        <div class="container">
                            <div class="row">
                                <div class="pro clearfix">
                                    ...
                                    <?php  $_result=M("product")->field("*")->where(" 1  and lang=3 AND status=1  AND catid in($r[id])")->order("listorder asc")->limit("10")->select();; if ($_result): $i=0;foreach($_result as $key=>$rr):++$i;$mod = ($i % 2 ); echo ($rr["sjcont"]); endforeach; endif;?>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- footer  -->
<footer>
    <a href="__PUBLIC__/www/images/New-Catalogue.pdf" target="_black" class="download">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Please submit message to download album</h4>
                    </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="pro clearfix">
                                    <a id="<?php echo ($r["catdir"]); ?>"></a>
                                    <h6><?php echo ($r["catname"]); ?></h6>
                                    <?php  $_result=M("product")->field("*")->where(" 1  and lang=3 AND status=1  AND catid in($r[id])")->order("listorder asc")->limit("10")->select();; if ($_result): $i=0;foreach($_result as $key=>$rr):++$i;$mod = ($i % 2 ); echo ($rr["cont"]); endforeach; endif;?>
                                </div>
                            </div>
                        </div>
                    </div>
