...
<body data-spy="scroll" data-target="#navbar-example">
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TK8ZBX2" height="0" width="0"
        ...
        <div class="product">
            ...
            <div class="content">
                <?php $n=0;foreach($Categorys as $key=>$r):if($n<100) :if( intval(132)==$r["parentid"] ) :++$n; if($r[isfooter]!=1) : ?>
                    ...
                    <?php else :?>
                <div class="list product-bg" <?php if($r[id]==140) : ?>style="margin-bottom: 50px;"<?php endif;?>>
                    <div class="">
                        <div class="container">
                            <div class="row">
<div class="pro clearfix">
            ...
            <div class="content clearfix">
                <div class="left col-lg-6 col-md-6 col-sm-6">
                    ...
                    <div class="footer-share">
                        ...
                        <a class="youtube" href="<?php echo ($youtube); ?>"
                            target="_blank">
                            <i class="fa fa-youtube" aria-hidden="true"></i>
                        </a>
                    </div>
...
<?php else :?>
<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WJQV28B"
